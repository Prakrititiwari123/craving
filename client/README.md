...
npm install
Create a .env file in the client root with API configuration:
...
API Integration
The application communicates with the backend API through src/config/Api.jsx. Axios is configured with base URL from environment variables.

Authentication
Authentication state is managed through src/context/AuthContext.jsx using React Context API. The context provides:
...
Add the route in your main routing configuration
Adding a New Component
Create the component in src/components/
Export it for use in pages
Modifying Styles
